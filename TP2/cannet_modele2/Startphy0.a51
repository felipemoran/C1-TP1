...
XDATALEN	EQU	7EFFH	; the length of XDATA memory in bytes.
;
PDATASTART	EQU	1H	; the absolute start-address of PDATA memory
...
; init de la carte phytec592
		...
		movx	@dptr,a		         
              ...
              MOV     TH1,#0FDH  
    ;FE pour un 11Mhz
    ;FD pour un 16Mh et 28800kb/s
		      orl	   PCON,#10000000B                              
              MOV     SCON,#01011010B ; Init Serial Interface
              SETB    TR1
; fin de l'init de la ligne série 28800kb/s
		LJMP	?C_START
